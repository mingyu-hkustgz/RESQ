...
if __name__ == "__main__":
    ...
    projection_path = os.path.join(path, f'P.fvecs')
    RN_path = os.path.join(path, f'RandNet.Ivecs')
    centroid_path = os.path.join(path, f'RandCentroid.fvecs')
    x2_path = os.path.join(path, f'x2.fvecs')
    x0_path = os.path.join(path, f'x0.fvecs')
    ...
    to_fvecs(x0_path, x0)
    to_fvecs(x2_path, x2)
    to_fvecs(centroid_path, X_mean.reshape((1, B)))
